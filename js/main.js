/**
 * Created by f5-studio on 07.11.2016.
 */

var template = `<div class="main_wrapper">
                    <div class="main_row">
                        <div class="logo_row">
                            <a href="/"><img src="${chrome.extension.getURL('img/logo.png')}"></a>
                        </div>
                        <div class="deal_row">
                            ...
                            <div class="compare_price_row">
                                <a class="compare_price_btn" id="toggle_prices">Compare prices <div class="caret-fix"></div></a>
                                <ul class="pricelist_ul">
                                    <li>
                                        <div class="comp_price"><span>120€</span></div>
                                        <div class="comp_logo"><img src="${chrome.extension.getURL('img/logos/amazonl_logo.png')}"></div>
                                        <a class="go_now">Go now >></a>
                                    </li>
                                    <li>
                                        <div class="comp_price"><span>150€</span></div>
                                        <div class="comp_logo"><img src="${chrome.extension.getURL('img/logos/LBC_logo.png')}"></div>
                                        <a class="go_now">Go now >></a>
                                    </li>
                                    <li>
                                        <div class="comp_price more_price"><span>160€</span></div>
                                        <div class="comp_logo"><img src="${chrome.extension.getURL('img/logos/priceminister_logo.png')}"></div>
                                        <a class="go_now">Go now >></a>
                                    </li>
                                    <li>
                                        <div class="comp_price more_price"><span>160€</span></div>
                                        <div class="comp_logo"><img src="${chrome.extension.getURL('img/logos/ebay_logo.png')}"></div>
                                        <a class="go_now">Go now >></a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="alerts_row">
                            <a class="toggle_alerts" id="toggle_alerst">Alerts <div class="caret-fix"></div></a>
                        ...
                        <div class="share_row">
                            <span>Share</span>
                            <ul>
                                <li><a><img src="${chrome.extension.getURL('img/socials/mail_icon.png')}"></a></li>
                                <li><a><img src="${chrome.extension.getURL('img/socials/twitter_icon.png')}"></a></li>
                                <li><a><img src="${chrome.extension.getURL('img/socials/facebook_icon.png')}"></a></li>
                            </ul>
                        </div>

                        <div class="close_bar_ico"></div>
                    </div>
                </div>`
